...
```{r, echo=FALSE}
# Place EVT_Root_measurements.csv in data/tables/ (see data/tables/README.md).
# Original hard-coded path: "~/Downloads/Google Drive/R & Stats/APIX5 & thermal test/EVT_Root_measurements.csv"
EVT_Root_measurements <- read.csv(here::here("data", "tables", "EVT_Root_measurements.csv"))
