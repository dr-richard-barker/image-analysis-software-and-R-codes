...
install_github("archiDART/archiDART", force = TRUE)
...
## this version allows you to upload your own RSML folders
library(shiny)
shiny::runGitHub("archidart/astrodart", "astridart")
...
/Users/drbhomeoffice/Pictures/TICTOC_Twist_Aligned/Results/RSML files/A68
...
path<-"/Users/drbhomeoffice/Pictures/TICTOC_Twist_Aligned/Results/RSML_files/All_renamed"
path<-"/Users/drbhomeoffice/Pictures/TICTOC_Twist_Aligned/Results/RSML_files/All_renamed/TICTOC_RSML file"
...
##archi2 <- rsmlToTable(path, fitter=T, rsml.connect = T, rsml.date="age")
